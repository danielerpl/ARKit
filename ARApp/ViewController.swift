...
//  ARApp
//
//  Created by Daniele Rapali on 24/07/2017.
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let scene = SCNScene(named: "art.scnassets/B_787_8")!
        self.treeNode = scene.rootNode.childNode(withName: "fuselage", recursively: true)
